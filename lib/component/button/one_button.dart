...
class _OneButtonState extends State<OneButton> {
  ...
  Color get _color => widget.color ?? OneColors.primary;
  ...
  BoxDecoration get _decoration {
    return BoxDecoration(
      color: (state != OneButtonState.outline && state != OneButtonState.borderless) || !enable ? OneColors.buttonGrey : _background,
      gradient: state != OneButtonState.primary || !enable ? null : _gradient,
      borderRadius: widget.borderRadius ?? BorderRadius.circular(22.0),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: OneButtonStyle.primary.copyWith(
