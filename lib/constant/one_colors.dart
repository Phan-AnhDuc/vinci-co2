...
class OneColors {
  static const blur = Color(0xFFBAD0E2);
  ...
  static const Color blueNavy = Color(0xFF2A6AEB);
  ...
  static const Color blueBlurLight = Color(0xFFA3D1FB);
  static const Color blueBgButton = Color(0xFFD3E3FE);
  ...
  //Diagnostic colors
  static const Color criticalAlarm = Color(0xFF990000);
  static const Color majorAlarm = Color(0xFFE69138);
  static const Color minorAlarm = Color(0xFFF1C232);
  static const Color infoAlarm = Color(0xFF009E0F);
  static const Color warningAlarm = Color(0xFF6FA8DC);
}
