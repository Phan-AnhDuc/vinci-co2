...
import 'package:MoveGreen/ui/background_location/location_callback_handler.dart';
import 'package:MoveGreen/ui/background_location/location_service_repository.dart';
...
class _BackgroundScreenState extends State<BackgroundScreen> {
  ...
  Future<void> _updateNotificationText(LocationDto data) async {
    await BackgroundLocator.updateNotificationText(title: "Vị trí hiện tại của bạn", msg: "${DateTime.now()} - DC", bigMsg: "${data.latitude}, ${data.longitude}");
  }
